...
<html>
	...
	<body>	
		...
		<br>
		<h2 class="titre_page">Bienvenue sur le</h2>
		<br>
		<h3 class="titre_page">Blog | Accueil</h3>
		<br><br><br>
		<div id="articles">
		...
		<h4>Ci-dessus, les deux derniers articles publiés</h4>
	</body>
...
body {
	margin: 0;
	padding: 0;
 	background-image: url('https://cdn.pixabay.com/photo/2018/09/16/00/27/magazine-3680550_1280.jpg'); 
